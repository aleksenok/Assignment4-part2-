          ...
          <div class="col-md-3 mt-3" style="display: inline-block">
            <div class="card bg-default shadow border-0">
              ...
              <blockquote class="card-blockquote">
                ...
                <?= $this->Form->postLink(__('- Cart'), ['action' => 'remove_from_cart', $product->id])?>
                </p>
              </blockquote>
            </div>
          </div>
          <?php endforeach;} else {?>
                    <p class="text-center col-md-12 ml-9">Oops, nothing to see here. Perhaps you should buy something.</p>
                <?php }?>
      </div>
